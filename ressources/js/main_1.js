...
/*les btns ont la classe js_show_btn pour etre interprétés
  data-nw-id-target attr du btn qui contient l'id de la div ciblé, 
  data-nw-classGroup toutes les classes concernés par cette section de btns (sont toutes effacées pour afficher que la bonne)
	et est utilisé aussi pour la gestion de l'affichage du bouton selectionné (appartiennent à un groupe)
/*-----------------------------------------------*/
